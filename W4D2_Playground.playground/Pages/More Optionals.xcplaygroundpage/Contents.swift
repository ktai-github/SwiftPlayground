 ...
 */
test!
//be careful because it is optional and might not contain anything
...
testData.contains { (nil) -> Bool in
  return true
}
print(testData.flatMap { $0 })
...
//let array: [String]? = [username!,password!,email!]
//if let username2 = username {
...
func doNotDivideByZero (number1: Int, number2: Int) {
  if number2 == 0 {
    return
  } else {
...
doNotDivideByZero(number1: 12, number2: 3)
/*:
 ...
 */
//func addNumbersInArray(myArray: [Int]) {
//  guard let myArray.first = nil else {
//
//      var sum = 0
//    for _ in myArray {
//      sum += myArray[IndexingIterator]
//    }
//
//  }
//}
