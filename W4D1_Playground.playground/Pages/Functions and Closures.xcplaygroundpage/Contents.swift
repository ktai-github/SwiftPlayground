 ...
 */
// 3 different functions with different return types and parameters
/*:
 - Experiment:
 ...
 */
func whatsUp(parameter1: String, parameter2: Int) -> String {
  return parameter1 + String(parameter2)
}
whatsUp(parameter1: "Kevin's age ", parameter2: 38)
/*:
 - Callout(Challenge):
 ...
 */
// different combinations of parameters and return types
/*:
 - Experiment:
 ...
 */
//: [Next](@next)
var testClosure = { (parameter3: Int, parameter4: Int) -> (Int) in
  return parameter3 + parameter4
}
func testFunc (testClosure: Int, parameter5: Int) {
  print(testClosure + parameter5)
}
let testClosureResult = testClosure(10,20)
testFunc(testClosure: testClosureResult, parameter5: 10)
