 ...
 */
var test : String? = nil
//this works because variable is optional
/*:
 ...
 */
stringVar = ""
//error because no digit to convert to double
 ...
 */
//optional variable and unwrapping optional variable
var stringVar2 : String? = "hello"
print(stringVar2!)
var stringVar3 = "hi"

stringVar2 = stringVar3
//nothing happens, still valid?
/*:
 Experiment:
...
if let unwrapped2 = numbers!.first {
  print("\(unwrapped2)")
}
if let unwrapped3 = numbers!.last {
  print("\(unwrapped3)")
}
/*:
 - Experiment:
...
if let mazda = cars!["Mazda3"] {
  print("\(mazda)")
}
if let crv = cars!["CRV"] {
  print("\(crv)")
}
if let hummer = cars!["Hummer"] {
  print("\(hummer)")
}
