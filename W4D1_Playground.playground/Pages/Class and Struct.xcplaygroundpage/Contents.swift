 ...
 */
let hello = ShapeClass()
hello.name = "hello kitty"
hello.numberOfSides = 5
hello.description()
/*:
 ...
 */
let testMyClass = NamedShapeClass(name: "hello", numberOfSides: 2)
...
class Square : NamedShapeClass {
  ...
  override func description() -> String {
    return "side length is \(self.sidelength) and number of sides is 4"
  }
}
let testSquare = Square(sideLength: 3, Name: "square1")
testSquare.name
...
class Toyota : Car {
  override init(modelName: String) {
    super.init(modelName: "Prius")
    
  }
}
var testToyota = Toyota(modelName: "Prius")
testToyota.model
testToyota.drive()
/*:
 - Callout(Challenge):
...
//second person is no longer joe
